 ...
 */	 
	public class PinPoint extends Point implements IEventDispatcher {
		...
		protected function init(target:DisplayObject, liquidStage:LiquidStage):void {
			_data = new LiquidData(this, target, 0, liquidStage || LiquidStage.getByStage(target.stage), false, 0, null, false);
		...
		public function attach(target:DisplayObject, strict:Boolean=false, reconcile:Boolean=true, tweenDuration:Number=0, tweenVars:Object=null, roundPosition:Boolean=false):void {
			_data.liquidStage.attach(target, this, strict, reconcile, tweenDuration, tweenVars, roundPosition);
		}
		/**
